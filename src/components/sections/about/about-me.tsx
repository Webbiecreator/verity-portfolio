  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_42%,rgba(199,85,247,0.16),transparent_34%),linear-gradient(to_bottom,rgba(16,6,26,0.08),rgba(16,6,26,0.28))]" />
        <motion.div
          style={{ y: gridY }}
        ...
        <div className="flex flex-1 flex-col justify-center">
          ...
          >
            <motion.p
              ...
              className="font-ledlight mb-5 text-sm uppercase text-violet-100/75 md:text-base"
            >
              VERITY
            </motion.p>

            <h1 className="font-roadster text-[17vw] font-medium leading-[0.8] tracking-[-0.065em] drop-shadow-[0_12px_50px_rgba(0,0,0,0.3)] sm:text-[14vw] md:text-[11vw]">
